...
const startLogOutTimer = function(){
  const tick = function(){
    ...
    //When 0 seconds , stop the timer & log out user
    if(time ===0){
      clearInterval(timer);
...
console.log(+'23');//23 , + opr will do type coersion
//Parsing
console.log(parseFloat('30px',10));//30
console.log(parseFloat('e23',10));//NAN
...
console.log(Math.min(5,8,11,23.2));//2
console.log(Math.PI * Number.parseFloat('10px') ** 2);//314.159625
...
console.log(+(2.345).toFixed(2));//retuns Number 2.35
...
//CREATE DATE
const now = new Date();//Tue Jan 11 2022 18:59:21 GMT+0530 (India Standard Time)
console.log(now);
console.log(new Date('Jan 11 2022 18:57:43'));//Tue Jan 11 2022 18:57:43 GMT+0530 (India Standard Time)
console.log(new Date('December 09,1987'));//Wed Dec 09 1987 00:00:00 GMT+0530 (India Standard Time)
...
console.log('US:    ',new Intl.NumberFormat('en-US',options).format(num));//US:     €3,563,274,937.23
console.log('Germany:    ',new Intl.NumberFormat('de-DE',options).format(num)); //Germany:     3.563.274.937,23 €
console.log('Syria:    ',new Intl.NumberFormat('ar-SY',options).format(num));//Syria:     ٣٬٥٦٣٬٢٧٤٬٩٣٧٫٢٣ €
console.log(navigator.language, new Intl.NumberFormat(navigator.language,options).format(num));//en-US €3,563,274,937.23
