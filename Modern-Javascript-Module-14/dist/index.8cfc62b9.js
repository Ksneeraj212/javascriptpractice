...
console.log(_shoppingCartJs.carty);
const state = {
    carty: [
        {
            product: "bread",
...
console.log(_shoppingCartJs.carty.find((el)=>el.quantity >= 2
));
...
parcelHelpers.export(exports, "carty", ()=>carty
);
...
},{"../internals/classof-raw":"bdfmm","../internals/global":"i8HOC"}]},["jWVwA","6rimH"], "6rimH", "parcelRequire15a1")
